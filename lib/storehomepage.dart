            ...
            child: GridView.count(
              ...
              children: [
                _buildMenuItem(context, 'Profile Update', Icons.person, () {
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context) => StoreEditPage()));
                }),
                _buildMenuItem(context, 'Product Update', Icons.cloud_upload,
                        () {
                      // Navigate to product update page
                      Navigator.push(context, MaterialPageRoute(builder: (context) => StoreProduct()));
                    }),
                _buildMenuItem(
                ...
                _buildMenuItem(context, 'Settings', Icons.settings, () {
                  ...
                  Navigator.push(context, MaterialPageRoute(builder: (context) => StoreSettings()));
                }),
              ],
            ),
          ),
